...
import gadgetbazaar.bulbana.sistem.dispatcher;

public class SettingsActivity extends Activity {

  /*  private List<Float> availableOptions = bulbanaapp.getConfigHelper().getSearchDistanceAvailableOptions();
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       float currentSearchDistance = bulbanaapp.getSearchDistance();
        ...
        searchDistanceRadioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                bulbanaapp.setSearchDistance(availableOptions.get(checkedId));
            }
        });
